...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  carouselItems: CarouselItem[] = [
    ...
    },
    {
      id: 7,
      icon: 'air',
      title: 'Desinfección de Aire UVC',
      description: 'sterilAir: elimina virus, bacterias y hongos en suspensión, mejorando la calidad del aire sin químicos.',
    ...
    },
    {
      id: 8,
      icon: 'water_drop',
      title: 'Desinfección de Agua UVC',
      description: 'sterilAir: agua microbiológicamente segura mediante luz ultravioleta UVC, sin añadir químicos.',
    ...
    },
    {
      id: 9,
      icon: 'wb_sunny',
      title: 'Desinfección de Superficies UVC',
      description: 'sterilAir: descontaminación continua de superficies y cintas transportadoras, sin detener la producción.',
