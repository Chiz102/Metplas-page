...
function CarouselComponent_For_9_Conditional_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", item_r2.image, \u0275\u0275sanitizeUrl)("alt", \u0275\u0275pipeBind1(2, 2, item_r2.title));
  }
}
function CarouselComponent_For_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 12);
    \u0275\u0275template(2, CarouselComponent_For_9_Conditional_2_Template, 4, 4);
    \u0275\u0275elementStart(3, "div", 13)(4, "div", 14)(5, "span", 4);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(7, "h3");
    \u0275\u0275text(8);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("width", 100 / ctx_r2.itemsVisible, "%");
    \u0275\u0275advance();
    \u0275\u0275classProp("has-image", !!item_r2.image);
    \u0275\u0275advance();
    \u0275\u0275conditional(2, item_r2.image ? 2 : -1);
    \u0275\u0275advance();
    \u0275\u0275classProp("on-image", !!item_r2.image);
    \u0275\u0275advance();
    \u0275\u0275classProp("light", !!item_r2.image);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(item_r2.icon);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 16, item_r2.title));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(12, 18, item_r2.description));
    \u0275\u0275advance(3);
    \u0275\u0275classProp("light", !!item_r2.image);
    \u0275\u0275property("routerLink", item_r2.link || "/catalogo");
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(16, 20, "carousel.viewMore"), " ");
  }
}
function CarouselComponent_For_15_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275classProp("active", i_r5 === ctx_r2.activeIndex);
  }
}
var CarouselComponent = class _CarouselComponent {
  ...
  static {
    ...
    }, inputs: { items: "items", itemsVisible: "itemsVisible" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 16, vars: 4, consts: [["viewport", ""], [1, "carousel-wrap"], [1, "carousel-outer", 3, "mouseenter", "mouseleave"], [1, "carousel-nav", "carousel-nav-prev", 3, "click"], [1, "material-icons-outlined"], [1, "carousel-viewport"], [1, "carousel-track"], [1, "carousel-slide", 3, "width"], [1, "carousel-nav", "carousel-nav-next", 3, "click"], [1, "carousel-dots"], [1, "cdot", 3, "active"], [1, "carousel-slide"], [1, "carousel-card"], [1, "card-content"], [1, "card-icon"], [1, "card-footer"], [1, "card-link", 3, "routerLink"], [1, "card-bg"], ["loading", "lazy", 3, "src", "alt"], [1, "card-overlay"], [1, "cdot", 3, "click"]], template: function CarouselComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(5, "div", 5, 0)(7, "div", 6);
        \u0275\u0275repeaterCreate(8, CarouselComponent_For_9_Template, 19, 22, "div", 7, \u0275\u0275repeaterTrackByIndex);
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275repeaterCreate(14, CarouselComponent_For_15_Template, 1, 2, "span", 10, _forTrack0);
        \u0275\u0275elementEnd()();
      }
      if (rf & 2) {
        \u0275\u0275advance(7);
...
function HomeComponent_For_110_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 98)(1, "span", 14);
    \u0275\u0275text(2, "public");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
...
function HomeComponent_For_110_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 50)(1, "div", 96);
    \u0275\u0275template(2, HomeComponent_For_110_Conditional_2_Template, 1, 2, "img", 97)(3, HomeComponent_For_110_Conditional_3_Template, 2, 0);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, HomeComponent_For_110_Conditional_4_Template, 4, 1, "span", 98);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function HomeComponent_For_146_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "a", 100)(1, "div", 101);
    \u0275\u0275element(2, "img", 102);
    \u0275\u0275elementEnd();
...
function HomeComponent_For_172_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 76)(1, "div", 105)(2, "video", 106);
    \u0275\u0275element(3, "source", 107);
    \u0275\u0275text(4, " Tu navegador no soporta videos HTML5. ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 108)(6, "h3");
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "p");
    \u0275\u0275text(9);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275attribute("aria-label", video_r9.title);
    \u0275\u0275advance();
    \u0275\u0275property("src", video_r9.src, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(video_r9.title);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(video_r9.subtitle);
  }
}
var HomeComponent = class _HomeComponent {
  constructor() {
    ...
    this.sterilairVideos = [
      {
        title: "Filtro de aire",
        subtitle: "Soluci\xF3n Sterilair para purificaci\xF3n de aire industrial.",
        src: "assets/videos/Filtro_de_aire.mp4"
      },
      {
        title: "Filtro de agua",
        subtitle: "Soluci\xF3n Sterilair para tratamiento y filtrado de agua.",
        src: "assets/videos/Filtro_de_agua.mp4"
      },
      {
        title: "Barreras UVC",
        subtitle: "Protecci\xF3n Sterilair con barreras UVC para superficies.",
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeComponent, selectors: [["app-home"]], hostBindings: function HomeComponent_HostBindings(rf, ctx) {
      ...
      if (rf & 1) {
        ...
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(158, "section", 72)(159, "div", 27)(160, "div", 73)(161, "span", 74);
        \u0275\u0275text(162, "ST\xC9RILAIR");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(163, "h2");
        \u0275\u0275text(164, "Soluciones en");
        \u0275\u0275element(165, "br");
        \u0275\u0275elementStart(166, "strong");
        \u0275\u0275text(167, "Filtro y Barreras UVC");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(168, "p");
        \u0275\u0275text(169, "Explora los videos de nuestros tres productos Sterilair: filtro de aire, filtro de agua y barreras UVC.");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(170, "div", 75);
        \u0275\u0275repeaterCreate(171, HomeComponent_For_172_Template, 10, 4, "div", 76, _forTrack2);
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(173, "section", 77)(174, "div", 78)(175, "div", 79)(176, "div", 80)(177, "span", 14);
        \u0275\u0275text(178, "lightbulb");
        \u0275\u0275elementEnd();
        \u0275\u0275text(179, " \xBFPor qu\xE9 Elegirnos? ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(180, "h2")(181, "em");
        \u0275\u0275text(182, "Compromiso con la");
        \u0275\u0275elementEnd();
        \u0275\u0275element(183, "br");
        \u0275\u0275elementStart(184, "strong");
        \u0275\u0275text(185, "EXCELENCIA");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(186, "p", 81);
        \u0275\u0275text(187, "M\xC1S DE 15 A\xD1OS PROPORCIONANDO SOLUCIONES DE ALTA CALIDAD A EMPRESAS L\xCDDERES EN CHILE.");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(188, "div", 82)(189, "div", 83)(190, "div", 84)(191, "span", 14);
        \u0275\u0275text(192, "verified");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(193, "div")(194, "h4");
        \u0275\u0275text(195, "Calidad Certificada");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(196, "p");
        \u0275\u0275text(197, "Productos con certificaciones internacionales que garantizan los m\xE1s altos est\xE1ndares.");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(198, "div", 83)(199, "div", 85)(200, "span", 14);
        \u0275\u0275text(201, "support_agent");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(202, "div")(203, "h4");
        \u0275\u0275text(204, "Soporte Especializado");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(205, "p");
        \u0275\u0275text(206, "Equipo t\xE9cnico capacitado para asesorarte en cada etapa de tu proyecto.");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(207, "div", 83)(208, "div", 84)(209, "span", 14);
        \u0275\u0275text(210, "local_shipping");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(211, "div")(212, "h4");
        \u0275\u0275text(213, "Distribuci\xF3n Nacional");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(214, "p");
        \u0275\u0275text(215, "Entrega a todo Chile con tiempos optimizados y seguimiento en tiempo real.");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(216, "div", 86)(217, "div", 87);
        \u0275\u0275element(218, "img", 88);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(219, "a", 89);
        \u0275\u0275text(220, " CONOCE M\xC1S SOBRE NOSOTROS ");
        \u0275\u0275elementStart(221, "span", 14);
        \u0275\u0275text(222, "arrow_forward");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(223, "section", 90)(224, "div", 91)(225, "div", 92);
        \u0275\u0275text(226, "\xBFLISTO PARA COMENZAR?");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(227, "h2");
        \u0275\u0275text(228, "OPTIMIZA TU OPERACI\xD3N");
        \u0275\u0275element(229, "br");
        \u0275\u0275elementStart(230, "span");
        \u0275\u0275text(231, "CON LOS MEJORES EQUIPOS");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(232, "p");
        \u0275\u0275text(233, "Cont\xE1ctanos hoy y descubre c\xF3mo podemos ayudarte a mejorar la eficiencia de tu negocio");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(234, "div", 93)(235, "a", 94)(236, "span", 14);
        \u0275\u0275text(237, "chat");
        \u0275\u0275elementEnd();
        \u0275\u0275text(238, " Solicitar Cotizaci\xF3n ");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(239, "a", 95)(240, "span", 14);
        \u0275\u0275text(241, "phone");
        \u0275\u0275elementEnd();
        \u0275\u0275text(242, " +569 9615 4315 ");
        \u0275\u0275elementEnd()()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(8);
