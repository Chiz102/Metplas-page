...
var ApiService = class _ApiService {
  ...
  // Categories
  getCategories() {
    return this.http.get(`${this.apiUrl}/categories/`).pipe(catchError(() => of(this.getMockCategories())));
  }
  getCategoryBySlug(slug) {
    return this.http.get(`${this.apiUrl}/categories/${slug}/`);
  }
  getCategoriesByType(type) {
    return this.http.get(`${this.apiUrl}/categories/by_type/?type=${type}`);
  }
  // SubCategories
  getSubCategories(categorySlug) {
    const url = categorySlug ? `${this.apiUrl}/subcategories/?category=${categorySlug}` : `${this.apiUrl}/subcategories/`;
    return this.http.get(url);
  }
  getSubCategoryBySlug(slug) {
    return this.http.get(`${this.apiUrl}/subcategories/${slug}/`);
  }
  // Products
  getProducts(subcategorySlug) {
    const url = subcategorySlug ? `${this.apiUrl}/products/?subcategory=${subcategorySlug}` : `${this.apiUrl}/products/`;
    return this.http.get(url);
  }
  getFeaturedProducts() {
    return this.http.get(`${this.apiUrl}/products/featured/`).pipe(catchError(() => of([])));
  }
  ...
  // Company Info
  getCompanyInfo() {
    return this.http.get(`${this.apiUrl}/company/`).pipe(catchError(() => of(this.getDefaultCompanyInfo())));
  }
    ...
    return [
      {
        ...
        description: "Equipos de alta precisi\xF3n para la industria",
      ...
      },
      {
        ...
        description: "Servicios t\xE9cnicos especializados",
        icon: "engineering",
        subcategories_count: 0
      },
      {
        id: 4,
        name: "Innovaci\xF3n y Desarrollo",
        slug: "innovacion",
  ...
  getDefaultCompanyInfo() {
    return {
      ...
      slogan: "Innovaci\xF3n y tecnolog\xEDa para la industria",
      phone: "+569 9615 4315",
      whatsapp: "+56996154315",
      email: "contacto@metplastech.cl",
      address: "Curic\xF3 \u2013 Regi\xF3n del Maule \u2013 Chile"
    };
  }
  static {
...
//# sourceMappingURL=chunk-ULP7W4R3.js.map
